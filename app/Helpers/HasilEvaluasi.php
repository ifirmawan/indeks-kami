...
class HasilEvaluasi 
{
	public static function tataKelola(int $responden_id)
	{
	...
	public static function risiko(int $responden_id)
	{
	...
	public static function kerangkaKerja(int $responden_id)
	{
	...
	public static function pengelolaanAset(int $responden_id)
	{
	...
	public static function teknologi(int $responden_id)
	{
