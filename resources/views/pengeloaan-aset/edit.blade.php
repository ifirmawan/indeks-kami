    ...
    <div class="col">
        <div class="page-header">
            ...
            <div class="section-block" id="basicform" tabindex="-1">
                <p>Bagian ini mengevaluasi kelengkapan pengamanan aset informasi, termasuk keseluruhan siklus penggunaan aset tersebut.<br/>
...
<div class="ecommerce-widget">
    ...
    <form action="{{ route('pengelolaan-aset.update',$responden->id) }}" method="post">
                ...
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <div class="toolbar ml-auto">
                            <a href="{{ route('pengelolaan-aset.index') }}" class="btn btn-default">
                                Kembali
                            </a>
                        </div>
                    </div>
