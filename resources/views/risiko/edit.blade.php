    ...
    <div class="col-lg-8">
        <div class="page-header">
            ...
            <div class="section-block" id="basicform" tabindex="-1">
                <p>Bagian ini mengevaluasi kesiapan penerapan pengelolaan risiko keamanan informasi sebagai dasar penerapan strategi keamanan informasi.<br/>
...
<div class="ecommerce-widget">
    ...
    <form action="{{ route('risiko.update',$responden->id) }}" method="post">
                ...
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <div class="toolbar ml-auto">
                            <a href="{{ route('risiko.index') }}" class="btn btn-default">
                                Kembali
                            </a>
                        </div>
                    </div>
