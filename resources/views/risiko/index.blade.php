    ...
    <div class="col">
        <div class="page-header">
            ...
            <div class="section-block" id="basicform" tabindex="-1">
                <p>Bagian ini mengevaluasi kesiapan penerapan pengelolaan risiko keamanan informasi sebagai dasar
                    penerapan strategi keamanan informasi.<br />
            ...
            <div class="card">
                <div class="card-header d-flex">
                    ...
                    <div class="toolbar ml-auto">
                        ...
                        <a href="{{ route('risiko.edit',$responden->id) }}" class="btn btn-primary btn-sm">
                ...
                <div class="card-body p-0">
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade active show" id="card-pill-0" role="tabpanel"
                            ...
                            @include('risiko.hasil-evaluasi',['hasil_evaluasi'=> $hasil_evaluasi])
                        </div>
