    ...
    <div class="col-lg-8">
        <div class="page-header">
            ...
            <div class="section-block" id="basicform" tabindex="-1">
                <p>Bagian ini mengevaluasi kelengkapan, konsistensi dan efektifitas penggunaan teknologi dalam pengamanan aset informasi.<br/>
...
<div class="ecommerce-widget">
    ...
    <form action="{{ route('teknologi.update',$responden->id) }}" method="post">
                ...
                <div class="card">
                    <div class="card-header d-flex">
                        ...
                        <div class="toolbar ml-auto">
                            <a href="{{ route('teknologi.index') }}" class="btn btn-default">
                                Kembali
                            </a>
                        </div>
                    </div>
